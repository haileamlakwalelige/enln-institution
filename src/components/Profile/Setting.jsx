    ...
    <div className="flex flex-col justify-center min-h-full">
      ...
      <div className="flex flex-col md:flex-row items-start justify-start gap-10 px-2  sm:p-4 md:p-12  ">
        ...
        <div className="mt-10 flex flex-col items-center justify-center lg:justify-between lg:px-32 md:flex-row">
          <div>
            <form className="grid w-full gap-x-10 gap-y-4 py-2 pb-5 grid-cols-1 lg:grid-cols-2 justify-center items-center">
            <div className="z-5 relative py-1">
                <input
                  type="text"
                  id="Name"
                  className="appearance-non peer relative block w-full min-w-[300px] max-w-[500px] border-2 border-b-2 border-gray-400 bg-transparent px-2 text-sm text-gray-200 focus:border-gray-600 focus:outline-none  focus:ring-0 dark:text-black dark:focus:border-gray-600"
          ...
          <div>
            <form>
             ...
             <div className='flex flex-col gap-1'>
                ...
                <input type="text" className='w-full outline-none focus:outline-none  border-[#187498] border-1.5 rounded-sm min-w-[300px] max-w-[500px]' />
              </div>
              <div className='flex flex-col gap-1'>
